...
dashboardRoutes.get('/summary', wrap(async (req, res) => {
    ...
    const [orders, active, delivered, todayOrders, totalSale, totalPaid, totalDues, todaySale, smartCards, classicCards, accrued, paidCommission, pendingCommission, balance, labCount, staffCount, registeredCustomers, unregisteredCustomers,] = await Promise.all([
        count((q) => q),
